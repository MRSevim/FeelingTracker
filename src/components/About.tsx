...
const About = () => {
  return (
    <div className="mt-15">
      ...
      <p className="mt-2">
        This website is done as personal tool. I needed something to track my
        day to day mood so I developed something simple like this. However,
        anyone can create an account and start tracking their mood. So feel free
        to do so and and let me know what you think!
      </p>
